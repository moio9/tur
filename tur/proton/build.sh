...
TERMUX_PKG_SRCURL=(
	https://github.com/airidosas252/wine-test/releases/download/Proton-9.0/wine-proton-9.0-arm64ec.tar.xz
)
TERMUX_PKG_SHA256=(
	a674ce79c49c4917e0e915063e5eb5205036d1cc8d38138021c8a1967d720528
)
